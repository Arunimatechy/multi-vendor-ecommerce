...
function AddProduct() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#fdf2f8] via-white to-[#fff7ed] py-10 px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto bg-white/80 backdrop-blur-2xl border border-pink-100 rounded-[40px] overflow-hidden shadow-2xl">
        ...
        {/* ================= HEADER ================= */}
        <div className="bg-gradient-to-r from-pink-500 via-rose-500 to-orange-400 p-10 text-white relative overflow-hidden">
